...
class Component {
    ...
    afterStart(cb) {
        ...
        logger.error('server [%s] afterStart and rpc client this.app.rpc = %j  this.app.sysrpc = %j this.client.proxies = %j', this.app.getServerId(), this.app.rpc, this.app.sysrpc, this.client.proxies);
    ...
    addServers(servers) {
        ...
        logger.error('server [%s] addServers %j this.app.rpc = %j this.app.sysrpc = %j this.client.proxies = %j', this.app.getServerId(), servers, this.app.rpc, this.app.sysrpc, this.client.proxies);
    }
